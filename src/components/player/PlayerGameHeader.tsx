...
const PlayerGameHeader: React.FC<PlayerGameHeaderProps> = ({
  ...
  return (
    <header className="p-4 border-b border-indigo-500/30 bg-gradient-to-r from-indigo-950/80 to-purple-950/80 backdrop-blur-sm">
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          <div className="bg-gradient-to-r from-indigo-500/30 to-purple-500/30 border border-indigo-500/40 text-white px-4 py-1.5 rounded-full shadow-md">
      ...
      {timeLeft > 0 && (
        <div className="w-full h-2 bg-gray-800 rounded-full mt-3 overflow-hidden shadow-inner">
          <div 
